...
"""
This module contains the support resources for the shell_command protocol.
...
from packages.eightballer.protocols.shell_command.serialization import (
    ShellCommandSerializer,
)


ShellCommandMessage.serializer = ShellCommandSerializer
